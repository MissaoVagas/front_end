...
const Destaque = () => {
  return (
    <div className=" text-white py-16 flex flex-col items-center space-y-8">
      <div className=" flex justify-center items-center space-x-8 md:space-x-16">
        <div className=" icon bg-red-500 rounded-full">
          <img
            src={icon1}
            alt="Hourglass Icon"
        ...
        <div className=" icon bg-custom-purple rounded-full">
          <img
            src={icon2}
            alt="Star Icon"
            className="w-12 h-12 md:w-16 md:h-16"
      ...
      <div className="search-bar flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-4 mt-6">
        ...
        <div className="flex items-center">
          ...
          <a
            href="#"
            className="advanced-search text-sm text-gray-400 hover:text-gray-200 ml-4"
          >
            Pesquisa avançada
          </a>
        </div>
