  ...
  const validateField = (name, value) => {
    ...
    switch (name) {
      ...
      case "sobrenome": {
        newErrors.sobrenome =
          value.length < 5
            ? "O sobrenome deve ter pelo menos 5 caracteres."
            : "";
        break;
      }
      case "cep": {
      ...
      case "linkedin": {
        newErrors.linkedin =
          value.length < 5
            ? "O usuário do LinkedIn deve ter mais de 5 caracteres."
            : "";
        break;
      }
      default:
  ...
  return (
    <div className="border-b border-gray-400/10 pb-12">
      ...
      <p className="mt-1 text-sm leading-6 text-gray-400">
        Essas informações serão usadas para entrar em contato com você.
      </p>
      ...
      <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
        ...
        <div className="sm:col-span-2">
          <label
            htmlFor="birthday"
            className="block text-sm text-white-900 dark:text-gray-300"
          >
            Data de Nascimento
          </label>
        ...
        <div className="sm:col-span-3">
          <label
            htmlFor="linkedin"
            className="block text-sm text-white-900 font-medium leading-6"
          >
            Linkedin
          </label>

          <div className="flex items-center mt-2">
            <p className="py-2.5 px-3 text-gray-400 bg-stone-800 dark:bg-gray-800 dark:border-gray-700 border border-r-0 rtl:rounded-r-lg rtl:rounded-l-none rtl:border-l-0 rtl:border-r rounded-l-lg">
        ...
        <div className="sm:col-span-6">
          <label htmlFor="curriculo" className="block text-sm text-white-900">
            Currículo
          </label>
